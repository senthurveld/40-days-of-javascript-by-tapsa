...
// clone.querySelector(".title").textContent = "This is Card 1";
// clone.querySelector(".desc").textContent =
//   "This Card 1 is created by template clone";

// document.body.appendChild(clone);

// clone1.querySelector(".title").textContent = "This is Card 1";
// clone1.querySelector(".desc").textContent =
//   "This Card 1 is created by template clone";
// document.body.appendChild(clone1);

// const arr = new Array((name = "senthur"), (age = "20"));
// console.log(arr);
// {
//   const [name,age,gender = "male"] = arr;
//   console.log(name);
//   console.log(age);
//   console.log(gender);
//   gender = "N/A"
...
function order() {
  ...
  let addon = prompt("enter your add-ons");
  console.log(nameIS +" and "+ addon);
}
order()
